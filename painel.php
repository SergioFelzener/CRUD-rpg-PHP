...
<nav>
  <span style="font-size:50px;cursor:pointer" onclick="openNav()">
    <img id="logoMenu" style="display:inline" src="https://img.icons8.com/cute-clipart/64/000000/list.png">
  </span>
  <div id="mySidenav" class="sidenav">
    ...
    <a href="listar_itens.php" style="margin-left:15px; margin-top: 10px;">Listar Itens</a>
    ...
    <a href="menu.php" class="float-right" style="margin-left:5; padding:15%;">Voltar</a>
    <a href="logout.php" class="float-left" style="margin-left:14px; padding:15%;">Sair</a>
  </div>
</nav>
