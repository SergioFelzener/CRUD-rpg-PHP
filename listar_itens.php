          ...
          while ($array = mysqli_fetch_array($busca)) {
            ...
            <tr>
              ...
              <td><a class="btn btn-primary btn-sm" style="color:#ffffff" href="editar_itens.php?id=<?php echo $id_itens ?>" role="button"><i class="fas fa-pencil-alt"></i>&nbsp; &nbsp; Editar</a>
                ...
                <a class="btn btn-danger btn-sm" style="color:#ffffff" data-confirm='Tem certeza que deseja apagar esse item?' href="deletar_itens.php?id=<?php echo $id_itens ?>" role="button"><i class="fas fa-trash-alt"></i>&nbsp; &nbsp; Apagar</a></td>
            </tr>
